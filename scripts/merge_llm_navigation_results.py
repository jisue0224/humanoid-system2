#!/usr/bin/env python3
"""Merge Step 5 LLM navigation condition summaries."""
...
parser = argparse.ArgumentParser(description="Merge LLM navigation summaries.")
...
def main() -> None:
    ...
    combined = {
        ...
        "summary_paths": {
            condition: str(output_dir / condition / "metrics" / f"{condition}_summary.json") for condition in CONDITIONS
        },
    }
    ...
    combined_path = metrics_dir / "llm_navigation_summary.json"
